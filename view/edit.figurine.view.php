...
<div class="form-group">    
    <label for="image" class="mb-3">Image</label>
     <input type="file" class="form-control" value="<?= $dragonball->getImage()?>" name="image" id="image"> <!-- affichage du titre du jeu dans input -->
</div>

<!----- input recuperant le nombre de joueurs du jeu dans bdd  ----->
<div class="form-group mt-5">    
    <label for="nbPlayers" class="mb-3">Nom</label>
    <input type="text" class="form-control" name="name" value="<?= $dragonball->getName()?>" id="name"> <!-- affichage du nbPlayers du jeu dans input -->
</div>

<!----- input recuperant le prix du jeu dans bdd  ----->
<div class="form-group">
    <label for="price" class="mb-3">Prix</label>
    <input type="number" class="form-control" name="price" value="<?= $dragonball->getPrice()?>">
</div>

<div class="form-group">
    <input type="hidden" class="form-control" name="id" value="<?= $dragonball->getId()?>" >
</div>
...
$title=" Editer : " . $dragonball->getName();
